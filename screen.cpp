...
bool Screen::checkForWindowError(){
    if(m_window == NULL){
        SDL_Quit();
        return false;
    }
...
bool Screen::checkForRendererError(){
    if(m_renderer == NULL){
...
bool Screen::checkForTextureError(){
    if(m_texture == NULL){
